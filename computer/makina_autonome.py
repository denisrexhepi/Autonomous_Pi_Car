...
from makina_autonome_ndihmes import *
...
class VideoStreamHandler(socketserver.StreamRequestHandler):
    ...
    nn = NeuralNetwork()
    nn.load_model('modeli_i_ruajtur/nn_model.xml')
            ...
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    if sensor_data and int(sensor_data) < self.d_sensor_thresh:
                        ...
                        print("Koha STOP: %.2fs" % self.stop_time)

                        # 5 seconds later, continue driving
                        if self.stop_time > 5:
                            print("Kaluan 5 sekonda")
                            stop_flag = False
